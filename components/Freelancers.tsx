        ...
        <div>
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto">
                {member.performanceNotes.length > 0 ? member.performanceNotes.map(note => (
                    ...
                    <p className="text-center text-brand-text-secondary py-8">Belum ada catatan kinerja.</p>
                )}
            </div>
        </div>
    </div>
                                                                    ...
                                                                    {record.projectPaymentIds.map(paymentId => {
                                                                        ...
                                                                        return (
                                                                            <li key={paymentId} className="text-brand-text-primary">
                                                                                {project?.projectName || 'N/A'} - <span className="font-semibold">{formatCurrency(payment?.fee || 0)}</span>
                                                                            </li>
                                                                        );
                                                                    })}
                                                                </ul>
